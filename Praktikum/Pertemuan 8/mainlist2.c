...
int main () {
    ...
    while (strcmp(Menu, "Q") != 0) {
        ...
        if     (strcmp(Menu, "1") == 0) {
            ...
            printf("List C :"); PrintList(D);
            printf("List D :"); PrintList(O);
            ...
            printf("List A :"); PrintList(E);
            printf("List B :"); PrintList(F);
            printf("List C :"); PrintList(G);
            printf("List D :"); PrintList(H);
            printf("List E :"); PrintList(O);
            printf("** Pilihan list : "); scanf(" %s", &Input);
            if      (strcmp(Input, "A") == 0) {
            ...
            printf("List C :"); PrintList(G);
            printf("List D :"); PrintList(H);
            printf("List E :"); PrintList(D);
            printf("List F :"); PrintList(O);
            printf("** Pilihan list : "); scanf(" %s", &Input);
            if      (strcmp(Input, "A") == 0) {
                printf("** Masukkan X : "); scanf(" %s", &Input); X = Input[0];
            ...
            printf("List A :"); PrintList(I);
            printf("List B :"); PrintList(J);
            printf("List C :"); PrintList(K);
            printf("List D :"); PrintList(L);
            printf("List E :"); PrintList(D);
            printf("List F :"); PrintList(O);
            printf("** Pilihan list : "); scanf(" %s", &Input);
            if      (strcmp(Input, "A") == 0) {
            ...
            printf("List C :"); PrintList(G);
            printf("List D :"); PrintList(H);
            printf("List E :"); PrintList(A);
            printf("List F :"); PrintList(B);
            printf("** Pilihan list : "); scanf(" %s", &Input);
            if      (strcmp(Input, "A") == 0) {
                CopyList(E,&M); Invers(&M); ShowStat(M);    
            }
            else if (strcmp(Input, "B") == 0) {
                CopyList(F,&M); Invers(&M); ShowStat(M);   
            }
            else if (strcmp(Input, "C") == 0) {
                CopyList(G,&M); Invers(&M); ShowStat(M);   
            }
            else if (strcmp(Input, "D") == 0) {
                CopyList(H,&M); Invers(&M); ShowStat(M);   
            }
            else if (strcmp(Input, "E") == 0) {
                CopyList(D,&M); Invers(&M); ShowStat(M);   
            }
            else if (strcmp(Input, "F") == 0) {
                CopyList(O,&M); Invers(&M); ShowStat(M);   
            }
            else {
                printf("Tidak ada pilihan list %s\n", Input);
            }
            ...
            if      (strcmp(Input, "1") == 0) {
                CopyList(E,&M); CopyList(F,&N); ConcatList(M,N,&P); ShowStat(P);    
            }
            else if (strcmp(Input, "2") == 0) {
                CopyList(G,&M); CopyList(H,&N); ConcatList(M,N,&P); ShowStat(P); 
            }
            else if (strcmp(Input, "3") == 0) {
                CopyList(A,&M); CopyList(B,&N); ConcatList(M,N,&P); ShowStat(P);  
            }
            else {
            ...
            printf("** Pilihan list : "); scanf(" %s", &Input);
            if      (strcmp(Input, "A") == 0) {
                CopyList(A,&P); SplitList(P,&M,&N); printf("Isi list M : "); ShowStat(M); printf("Isi list N : "); ShowStat(N);   
            }
            else if (strcmp(Input, "B") == 0) {
                CopyList(B,&P); SplitList(P,&M,&N); printf("Isi list M : "); ShowStat(M); printf("Isi list N : "); ShowStat(N);  
            }
            else if (strcmp(Input, "C") == 0) {
                CopyList(C,&P); SplitList(P,&M,&N); printf("Isi list M : "); ShowStat(M); printf("Isi list N : "); ShowStat(N);   
            }
            else if (strcmp(Input, "D") == 0) {
                CopyList(D,&P); SplitList(P,&M,&N); printf("Isi list M : "); ShowStat(M); printf("Isi list N : "); ShowStat(N);    
            }
            else if (strcmp(Input, "E") == 0) {
                CopyList(O,&P); SplitList(P,&M,&N); printf("Isi list M : "); ShowStat(M); printf("Isi list N : "); ShowStat(N);  
            }
            else {
                printf("Tidak ada pilihan list %s\n", Input);
            }
